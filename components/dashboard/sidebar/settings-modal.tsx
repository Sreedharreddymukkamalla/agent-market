...
export const SettingsModal = ({ isOpen, onOpenChange }: SettingsModalProps) => {
  ...
  const tabs = [
    ...
    { id: "privacy", label: "Privacy & Access", icon: <ShieldIcon size={18} /> },
      ...
      case "appearance":
        return (
          <div className="flex flex-col gap-8">
            <div>
              <h3 className="text-2xl font-bold text-default-900 leading-tight">Appearance Settings</h3>
        ...
        return (
          <div className="flex flex-col gap-8">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <Card variant="secondary" className="p-4 border border-default-100/50 shadow-sm">
                <Card.Header className="flex-col items-start gap-1 p-0">
                  <span className="text-[10px] font-bold text-default-400 uppercase tracking-widest">PLAN</span>
                  <Card.Title className="text-2xl font-bold text-default-900">Pro</Card.Title>
                </Card.Header>
                <Card.Footer className="pt-3 p-0">
                  <Button size="sm" variant="ghost" className="text-primary font-bold p-0 h-auto hover:bg-transparent hover:underline">
                    Upgrade to Business
                  </Button>
                </Card.Footer>
              </Card>
              ...
              <Card variant="secondary" className="p-4 border border-default-100/50 shadow-sm">
                <Card.Header className="flex-col items-start gap-1 p-0">
                  <span className="text-[10px] font-bold text-default-400 uppercase tracking-widest">BILLING CYCLE</span>
                  <Card.Title className="text-2xl font-bold text-default-900">Monthly</Card.Title>
                </Card.Header>
                <Card.Footer className="flex items-center gap-2 pt-3 p-0">
                  <Button size="sm" variant="ghost" className="text-primary font-bold p-0 h-auto hover:bg-transparent hover:underline">
                    Switch to annual
                  </Button>
                  <Chip size="sm" className="bg-success-50 text-success-600 font-bold px-2 py-0 h-5 text-[9px] border border-success-100">
                    SAVE $144 / YEAR
                  </Chip>
                </Card.Footer>
              </Card>
            ...
            <div className="flex flex-col gap-6 pt-2">
              <div className="flex flex-col gap-1">
                <h3 className="text-lg font-bold text-default-900">Billing details</h3>
              ...
              <div className="flex flex-col gap-4">
                <div className="flex justify-between items-center py-2 border-b border-default-100/50">
                  <span className="text-xs font-bold text-default-400 uppercase tracking-wider">Payment Method</span>
                  <div className="flex items-center gap-3">
                    <span className="text-sm font-bold text-default-900">Mastercard •••• 2461</span>
                    <span className="text-xs font-medium text-default-400">Expires 02/2028</span>
                  </div>
                </div>
                <div className="flex justify-between items-center py-2 border-b border-default-100/50">
                  <span className="text-xs font-bold text-default-400 uppercase tracking-wider">Billing Contact</span>
                  <span className="text-sm font-bold text-default-900">tech@agentmarket.ai</span>
                </div>
                <div className="flex justify-between items-center py-2">
                  <span className="text-xs font-bold text-default-400 uppercase tracking-wider">Invoice History</span>
                  <Button size="sm" variant="ghost" className="text-primary font-bold p-0 h-auto hover:bg-transparent hover:underline">
                    View in Stripe
                  </Button>
                </div>
              ...
              <div className="mt-2">
                <Button
                  ...
                  onPress={() => window.open("https://billing.stripe.com", "_blank")}
                >
              ...
              <div className="pt-6 border-t border-default-100">
                <div className="flex justify-between items-center">
                  <div className="flex flex-col">
                    <h4 className="text-sm font-bold text-default-900">Cancel subscription</h4>
                    <p className="text-xs text-default-500 mt-0.5">
                      Your subscription will remain active until the end of this period.
                    </p>
                  </div>
                  <Button size="sm" className="bg-red-500/10 text-red-500 font-bold px-5 rounded-xl hover:bg-red-500/20 transition-colors h-10">
                    Cancel
                  </Button>
                </div>
              </div>
          ...
          <div className="flex flex-col gap-8">
            <Accordion hideSeparator className="w-full">
              <Accordion.Item key="privacy">
                <Accordion.Heading>
                  <Accordion.Trigger className="py-4 hover:bg-default-50/50 -mx-2 px-2 rounded-xl transition-colors">
                    <span className="text-lg font-bold text-default-900">Privacy</span>
                    <Accordion.Indicator>
                      <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-default-400"><polyline points="6 9 12 15 18 9"></polyline></svg>
                    </Accordion.Indicator>
                  </Accordion.Trigger>
                </Accordion.Heading>
                <Accordion.Panel>
              ...
              <Accordion.Item key="email">
                <Accordion.Heading>
                  <Accordion.Trigger className="py-4 hover:bg-default-50/50 -mx-2 px-2 rounded-xl transition-colors">
                    <span className="text-lg font-bold text-default-900">Email settings</span>
                    <Accordion.Indicator>
                      <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-default-400"><polyline points="6 9 12 15 18 9"></polyline></svg>
                    </Accordion.Indicator>
                  </Accordion.Trigger>
                ...
                <Accordion.Panel>
                  <Accordion.Body className="py-4 text-default-500 text-sm">
                    Configure which emails you receive and how your address is used.
                  </Accordion.Body>
                </Accordion.Panel>
              </Accordion.Item>
              ...
              <Accordion.Item key="account">
                <Accordion.Heading>
                  <Accordion.Trigger className="py-4 hover:bg-default-50/50 -mx-2 px-2 rounded-xl transition-colors">
                    <span className="text-lg font-bold text-default-900">Account management</span>
                    <Accordion.Indicator>
                      <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-default-400"><polyline points="6 9 12 15 18 9"></polyline></svg>
                    </Accordion.Indicator>
                  </Accordion.Trigger>
          ...
          <div className="flex flex-col items-center justify-center h-full text-center py-20 gap-6">
            ...
            <div className="space-y-2">
              ...
              <p className="text-default-500 max-w-sm mx-auto leading-relaxed">
                We're currently building this section. Soon you'll be able to manage all your {label.toLowerCase()} settings here.
              </p>
            </div>
            <Button variant="outline" className="rounded-xl px-6">Notify me when ready</Button>
          </div>
        );
    }
  };
  ...
  return (
    <ModalRoot isOpen={isOpen} onOpenChange={onOpenChange}>
      <ModalBackdrop className="bg-black/20 backdrop-blur-sm" variant="blur">
        <ModalContainer
          placement="center"
          className="p-4"
        >
          <ModalDialog className="bg-background border border-divider/50 shadow-2xl rounded-[2rem] overflow-hidden flex flex-col w-full max-w-4xl h-[600px] outline-none animate-in zoom-in-95 fade-in duration-300 relative">
            ...
            <div className="relative p-0 h-20 flex items-center shrink-0">
              <h2 className="text-2xl font-bold text-default-900 tracking-tight px-9">Settings</h2>
            </div>
            ...
            <div className="flex flex-row flex-1 overflow-hidden">
              ...
              <div className="w-[240px] shrink-0 flex flex-col px-6 py-2 overflow-y-auto">
                <div className="flex flex-col gap-1">
                  {tabs.map((tab) => {
                    if (tab.type === "divider") {
                      return <Separator key={tab.id} className="my-3 opacity-50 mx-2" />;
                    }
                    ...
                    return (
                      ...
                      >
                        <span className={clsx("shrink-0", isActive ? "text-default-900" : "text-default-400")}>
                          {tab.icon}
                        </span>
