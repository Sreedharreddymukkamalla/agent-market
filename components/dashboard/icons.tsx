...
export const BillingIcon = ({
  ...
  >
    <path
      ...
      fill={fill}
    />
    <circle cx="16" cy="12" fill={fill} r="1.5" />
  </svg>
);
...
export const ShieldIcon = ({
  ...
  >
    <path
      ...
      fill={fill}
    />
    <path d="M10.5 12.5l1.5 1.5 3-3" fill="currentColor" opacity="0.2" />
  </svg>
);
...
export const MCPIcon = ({
  ...
  >
    ...
    >
      ...
      <rect height="6" rx="1.5" width="10" x="3" y="14" />
...
export const RobotIcon = ({
  ...
  >
    ...
    />
    {/* Antenna ball */}
    <circle cx="12" cy="1" fill="currentColor" r="1" />
    ...
    {/* Left eye */}
    <circle cx="9" cy="8.75" fill="currentColor" opacity="0.9" r="1.5" />
    <circle cx="9.5" cy="8.25" fill="currentColor" opacity="0.3" r="0.4" />

    {/* Right eye */}
    <circle cx="15" cy="8.75" fill="currentColor" opacity="0.9" r="1.5" />
    <circle cx="15.5" cy="8.25" fill="currentColor" opacity="0.3" r="0.4" />

    {/* Mouth dots */}
    <circle cx="10" cy="12.5" fill="currentColor" opacity="0.7" r="0.6" />
    <circle cx="12" cy="12.5" fill="currentColor" opacity="0.7" r="0.6" />
    <circle cx="14" cy="12.5" fill="currentColor" opacity="0.7" r="0.6" />
    ...
    {/* Chest LEDs */}
    <circle cx="10" cy="19" fill="currentColor" opacity="0.9" r="0.8" />
    <circle cx="12" cy="19" fill="currentColor" opacity="0.5" r="0.8" />
    <circle cx="14" cy="19" fill="currentColor" opacity="0.9" r="0.8" />
