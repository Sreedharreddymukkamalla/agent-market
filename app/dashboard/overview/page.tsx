  ...
  if (loading) {
    return (
      <div className="flex min-h-[400px] flex-col items-center justify-center gap-4">
        ...
        <p className="animate-pulse text-default-500">
    ...
    <div className="flex flex-col gap-6">
      <div className="flex flex-col gap-1">
        ...
        <p className="text-default-500">
          Welcome back! Manage your active AI agents and explore new
          opportunities.
        </p>
      </div>
        ...
        <section className="mt-4 flex flex-col items-center gap-6 rounded-2xl border border-divider bg-surface-secondary p-12 text-center">
          <div className="flex flex-col gap-2">
            ...
            <p className="max-w-md text-lg text-default-500">
              Start by discovering and deploying specialized AI agents from our
              Agent MarketPlace.
            </p>
          </div>
          <Link href="/dashboard/marketplace">
            <Button
              className="rounded-xl px-12 font-semibold"
              size="lg"
              variant="primary"
            >
      ...
      {agents.length > 0 && (
        <section className="mt-8 flex flex-col items-center gap-4 rounded-2xl border border-divider bg-surface-secondary p-8 text-center">
          ...
          <p className="max-w-md text-default-500">
            Access specialized AI templates in our Agent MarketPlace to automate
            your repetitive workflows today.
          </p>
          <Link href="/dashboard/marketplace">
            <Button
              className="rounded-xl px-12 font-semibold"
